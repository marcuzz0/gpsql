# gpsql
## Premessa
gpsql (gestione psql) è uno script shell scritto in bash che permette la gestione di database Postgresql in ambiente shell includendo una svariata serie di comandi in psql.
